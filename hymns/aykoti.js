export default {
    name: "Aykoti",
      "coptic": [
        ...
        "+ `Fholj `nje [email&#160;protected] teketvw aici`[email&#160;protected] Pa[oic [email&#160;protected] `aribo`y;in `eroi. \n+ Qen oucyou [email&#160;protected] ek`ecwtem `[email&#160;protected] Pa[oic Iycouc Pi`,[email&#160;protected] `aribo`y;in `eroi. ",
      ...
      "copticEnglish": [
        "Aikoti ensowk, khen epshowk empa-heet, pashois Esos, ari-voythen eroy.Voytheen eroi pashois isos pi ref shenheet pashois Esos Pekhrestos, ari-voythen eroy.",
